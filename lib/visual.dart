...
class _VisualPageState extends State<VisualPage> {
      ...
      _flutterTts.setErrorHandler((msg) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text("Speech error: Please check your device's text-to-speech settings"),
  ...
  Future<String> _generateSummary(String documentPath) async {
    try {
      ...
      if (content.isEmpty || content.startsWith('Error') || content.startsWith('Unable')) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => VisualFlashCardsScreen(
              ...
              onSpeakingChanged: (speaking) => setState(() => _isSpeaking = speaking),
            ),
          ),
        );
      }
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        _speak("This is a test of the text to speech functionality for visual learning accessibility.");
                      },
                      icon: Icon(
                ...
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 16 * _fontScale,
                      fontWeight: _boldText ? FontWeight.bold : FontWeight.normal,
                      color: _highContrast ? Colors.white : Theme.of(context).primaryColor,
                    ),
                  ),
                ),
              ],
    ...
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        final documentInfo = {
          ...
          'description': 'Visual learning document uploaded on ${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}',
        };
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              backgroundColor: _highContrast ? Colors.grey[800] : const Color(0xFF7B2D93),
            ),
          );
        }
      }
                    ...
                    Row(
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            color: _highContrast ? Colors.grey[400] : Colors.grey[600],
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 16 * _fontScale,
                                fontWeight: FontWeight.bold,
                                color: _highContrast ? Colors.white : const Color(0xFF2D2D2D),
                              ),
                            ),
                          ),
                        ],
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _highContrast ? Colors.grey[800] : const Color(0xFFF8F9FA),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: const Color(0xFF7B2D93).withOpacity(0.1),
                            width: 1,
                          ...
                          children: [
                            ...
                            SliderTheme(
                              data: SliderTheme.of(context).copyWith(
                                ...
                                inactiveTrackColor: const Color(0xFF7B2D93).withOpacity(0.3),
                                thumbColor: const Color(0xFF7B2D93),
                                thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10 * _fontScale),
                                overlayColor: const Color(0xFF7B2D93).withOpacity(0.2),
            ...
            uploadedDocuments.isEmpty
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _highContrast ? Colors.grey[600]! : Colors.grey[300]!,
                      ),
                    ),
                    child: Column(
                      children: [
                        Icon(
                          Icons.cloud_upload,
                          size: 48 * _fontScale,
                          color: _highContrast ? Colors.grey[400] : Colors.grey[400],
                        ),
                        SizedBox(height: 16 * _fontScale),
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 16 * _fontScale,
                            color: _highContrast ? Colors.grey[400] : Colors.grey[600],
                            fontWeight: _boldText ? FontWeight.w600 : FontWeight.w500,
                          ),
                        ),
                        SizedBox(height: 8 * _fontScale),
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 14 * _fontScale,
                            color: _highContrast ? Colors.grey[500] : Colors.grey[500],
                            fontWeight: _boldText ? FontWeight.w500 : FontWeight.normal,
                          ),
...
class _VisualSummaryScreenState extends State<VisualSummaryScreen> {
  ...
  Future<void> _testTts() async {
    try {
      ...
      var result = await _flutterTts.speak("This is a test of the text to speech system");
      print("Test TTS result: $result");
      
      if (result == 1) {
        print("TTS test successful");
      } else {
        print("TTS test failed with result: $result");
      }
    } catch (e) {
    ...
    try {
      if (_isSpeaking) {
        ...
        String cleanText = widget.summary
            .replaceAll(RegExp(r'\*\*\*(.*?)\*\*\*'), r'\1')  // Remove bold italic
        ...
        if (cleanText.isNotEmpty) {
          print("Attempting to speak text: ${cleanText.substring(0, cleanText.length > 100 ? 100 : cleanText.length)}...");
          ...
          try {
            ...
            // Set TTS parameters
            await _flutterTts.setSpeechRate(0.4); // Slower rate
            await _flutterTts.setVolume(0.8);
            await _flutterTts.setPitch(1.0);
            ...
            if (cleanText.length > 2000) {
              ...
              for (String chunk in chunks) {
                ...
                print("Speaking chunk: ${chunk.substring(0, chunk.length > 50 ? 50 : chunk.length)}...");
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: widget.highContrast ? Colors.grey[300] : Colors.grey[600],
  ...
  Widget _buildMarkdownFormattedText(String markdownText) {
    ...
    for (int i = 0; i < lines.length; i++) {
      ...
      // Handle headers
      if (line.startsWith('### ')) {
        widgets.add(_buildHeader(line.substring(4), 18 * widget.fontScale, FontWeight.w600));
      } else if (line.startsWith('## ')) {
        widgets.add(_buildHeader(line.substring(3), 20 * widget.fontScale, FontWeight.bold));
      } else if (line.startsWith('# ')) {
        widgets.add(_buildHeader(line.substring(2), 22 * widget.fontScale, FontWeight.bold));
      }
  ...
  Widget _buildHeader(String text, double fontSize, FontWeight fontWeight) {
    return Container(
      margin: EdgeInsets.only(top: 20 * widget.fontScale, bottom: 12 * widget.fontScale),
      child: Text(
        text,
        style: TextStyle(
          fontSize: fontSize,
  ...
  Widget _buildBulletPoint(String text) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            margin: EdgeInsets.only(top: 6 * widget.fontScale, right: 8 * widget.fontScale),
      ...
      if (widget.isSpeaking) {
        ...
        widget.flutterTts.setErrorHandler((msg) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text("Cannot speak question: Please check TTS settings"),
                backgroundColor: Colors.red,
              ),
            );
          }
                  ...
                  child: Column(
                    children: [
                      ...
                      LinearProgressIndicator(
                        value: (currentCardIndex + 1) / widget.flashCards.length,
                        backgroundColor: widget.highContrast ? Colors.grey[700] : Colors.grey[300],
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Icon(
                                  ...
                                  color: widget.highContrast ? Colors.white : Theme.of(context).primaryColor,
                                ),
                                ...
                                Container(
                                  ...
                                  child: IconButton(
                                    ...
                                    tooltip: widget.isSpeaking 
                                        ? 'Stop Reading' 
                                        : (isFlipped ? 'Read Answer Aloud' : 'Read Question Aloud'),
                                  ),
                                ),
                              ],
                            ),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 18 * widget.fontScale,
                                fontWeight: widget.boldText ? FontWeight.bold : FontWeight.w600,
                                color: widget.highContrast ? Colors.grey[400] : Colors.grey[600],
                              ),
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: _flipCard,
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: widget.highContrast ? Colors.white : null,
                                    padding: EdgeInsets.symmetric(
