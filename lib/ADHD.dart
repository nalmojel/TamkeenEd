...
class FocusTimerService extends ChangeNotifier {
  ...
  bool get isRunning => _isRunning; // Use local state instead of stopwatch state
  ...
  void _initializeTimer() {
    _stopWatchTimer = StopWatchTimer(
      ...
      onChange: (value) {
        print("DEBUG: Timer value changed to: $value, isRunning: ${_stopWatchTimer.isRunning}");
  ...
  String formatTime(int milliseconds) {
    return StopWatchTimer.getDisplayTime(milliseconds, hours: false, milliSecond: false);
  }
      ...
      switch (extension.toLowerCase()) {
        ...
        case 'pdf':
          try {
            ...
            return content.isNotEmpty ? content : 'Unable to extract text from this PDF file. The file may be image-based or encrypted.';
          } catch (e) {
          ...
          try {
            ...
            for (final file in archive) {
              if (file.name == 'word/document.xml') {
                ...
                return textContent.isNotEmpty ? textContent : 'Unable to extract text from this DOCX file.';
              }
            }
    ...
    try {
      ...
      if (extractedText.isEmpty) {
        ...
        for (final match in simpleMatches) {
          ...
          if (textContent != null && textContent.isNotEmpty && textContent.length > 2) {
            extractedText.write(textContent);
            extractedText.write(' ');
          }
        }
...
class _FocusTimerScreenState extends State<FocusTimerScreen> with TickerProviderStateMixin {
                            ...
                            Wrap(
                              ...
                              children: _timeOptions.map((option) {
                                ...
                                if (seconds != null) {
                                  ...
                                  isSelected = timerService.presetMilliseconds == seconds * 1000;
                                } else if (minutes != null) {
                                  // For minute-based options, compare selected minutes
                                  isSelected = timerService.selectedMinutes == minutes;
                                }
                                              ...
                                              Center(
                                                child: SizedBox(
                                                  ...
                                                  child: CircularProgressIndicator(
                                                    value: timerService.presetMilliseconds > 0
                                                      ? (timerService.presetMilliseconds - timerService.stopWatchTimer.rawTime.value) / timerService.presetMilliseconds
                                                      : 0.0,
                                                    strokeWidth: 8,
                                                    backgroundColor: Colors.grey[200],
                                                      ...
                                                      children: [
                                                        Text(
                                                          ...
                                                          style: TextStyle(
                                                            ...
                                                            color: value == 0 
                                                              ? const Color(0xFF7B2D93)
                                                              : const Color(0xFF5D1A73),
                                                            fontFamily: 'monospace',
                                                          ),
                                                        ),
                                                        const SizedBox(height: 8),
                                                        Text(
                                                          _getTimerStatusText(timerService),
                                                          style: TextStyle(
                                                            fontSize: 16,
                                                            color: Colors.grey[600],
                                                            fontStyle: FontStyle.italic,
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  elevation: 4,
                                  shadowColor: const Color(0xFF7B2D93).withOpacity(0.4),
                                ),
                              ),
                            ],
                          ),
  ...
  String _getTimerStatusText(FocusTimerService timerService) {
    if (timerService.isRunning) {
      return 'Stay focused...';
    } else if (timerService.stopWatchTimer.rawTime.value > 0 && timerService.stopWatchTimer.rawTime.value < timerService.presetMilliseconds) {
